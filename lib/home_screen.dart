...
class HomeState extends State<Home> {
  ...
  final Map<String, AssetImage> images = {
    ...
    "Dust": AssetImage("assets/images/dust.jpg"),
    "Smoke": AssetImage("assets/images/smoke.jpg"),
  };
  final Map<String, AssetImage> night = {
    ...
    "Snow": AssetImage("assets/gifs/snow.gif"),
    "Drizzle": AssetImage("assets/gifs/drizzle.gif"),
    "Dust": AssetImage("assets/night/dust.jpg"),
    "Smoke": AssetImage("assets/night/smoke.jpg"),
  };
  ...
  _getAddressFromLatLng() async {
    try {
      ...
      weatherData.name = "${place.locality}";
      forecastData.name = "${place.locality}";
      getData();
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Icon(
                                        ...
                                        color: (sunriseTime.compareTo(
                                                        DateTime.now()) <
                                                    0) &&
                                                (sunsetTime.compareTo(
                                                        DateTime.now()) >
                                                    0)
                                            ? Colors.black
                                            : Colors.white,
